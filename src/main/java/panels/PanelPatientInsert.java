...
public class PanelPatientInsert extends JPanel {
	...
	public PanelPatientInsert(PanelPatient panelPatient) {
		...
		panelButtons.add(btnInsert, gbcPanelOperations);
	...
	public void insertNewPatient() {
		...
		try {
			...
			Database.insertPatient(new Patient(0, firstName, lastName, age, disease, emailAddress, mailAddress, address,
					telephoneNumber));
			panelPatient.updateAfterInsert();
